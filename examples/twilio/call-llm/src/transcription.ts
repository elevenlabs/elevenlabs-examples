...
export class Transcription extends EventEmitter {
  ...
  constructor() {
    ...
    this.deepgramLive.addListener('error', (error: unknown) => {
      console.error('STT -> deepgram error');
      console.error(error);
    });

    this.deepgramLive.addListener('warning', (warning: unknown) => {
      console.error('STT -> deepgram warning');
      console.error(warning);
    });

    this.deepgramLive.addListener('metadata', (metadata: unknown) => {
